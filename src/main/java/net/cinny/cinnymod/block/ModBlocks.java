...
public class ModBlocks {
    public static final Block CANOPIC_POT = registerBlock("canopic_pot", new Block(AbstractBlock.Settings.create().sounds(BlockSoundGroup.DEEPSLATE_TILES).strength(2.5f, 3f).nonOpaque()));
